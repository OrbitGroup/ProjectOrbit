...
namespace TriangleCollector
{
    public class TriangleCollector
    {
        ...
        public static List<Type> ExchangesToInitialize = new List<Type>() { typeof(BinanceExchange), typeof(HuobiExchange), typeof(HitbtcExchange)}; //list of exchanges to initialize. Valid names are 'hitbtc', 'huobi', and 'binance'
