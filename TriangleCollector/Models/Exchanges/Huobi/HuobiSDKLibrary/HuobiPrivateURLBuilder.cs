using System;
using ProjectOrbit.Models.Exchanges.Huobi.HuobiSDKLibrary;

namespace ProjectOrbit.Models.Exchanges.Huobi
{
    public class HuobiPrivateUrlBuilder
    {
        ...
        private readonly HuobiSignatureGenerator _signer;

        public HuobiPrivateUrlBuilder(string accessKey, string secretKey, string host)
        {
            _aKValue = accessKey;
            _signer = new HuobiSignatureGenerator(secretKey);
